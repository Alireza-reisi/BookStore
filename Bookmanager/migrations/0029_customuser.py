    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, default='default.jpg', upload_to='profile_pictures/')),
                ('favorite_books', models.ManyToManyField(blank=True, to='Bookmanager.book')),
